...
| `catalog/language-style-guide-patterns.md` | Google's Python and C++ style guides read directly, with the guide's own stated rationale for each restriction — the "restrict the language for a stated scale/correctness reason" pattern, and how it echoes the project-governance module-boundary pattern above. |
